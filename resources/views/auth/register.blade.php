...
<div class="mt-4">
    ...
    <x-text-input id="restaurant_name" class="block mt-1 w-full" type="text" name="restaurant_name" :value="old('restaurant_name')" required autofocus autocomplete="restaurant_name" />
